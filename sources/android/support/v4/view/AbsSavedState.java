...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = new C03622();
    public static final AbsSavedState EMPTY_STATE = new C03611();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C03611 extends AbsSavedState {
        C03611() {
            super();
        }
    }
    ...
    static class C03622 implements ClassLoaderCreator<AbsSavedState> {
        C03622() {
        }
