...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C03701();
    ...
    private static final Interpolator sInterpolator = new C03712();
    ...
    private final Runnable mEndScrollRunnable = new C03723();
    ...
    static class C03701 implements Comparator<ItemInfo> {
        C03701() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        ...
        static class C03741 implements ClassLoaderCreator<SavedState> {
            C03741() {
            }
