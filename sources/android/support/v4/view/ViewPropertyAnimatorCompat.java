...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m1289x(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m1290y(float value) {
        View view = (View) this.mView.get();
        if (view != null) {
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m1291z(float value) {
        View view = (View) this.mView.get();
        if (view != null && VERSION.SDK_INT >= 21) {
