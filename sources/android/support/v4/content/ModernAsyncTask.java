...
abstract class ModernAsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sThreadFactory = new C02681();
    ...
    private final WorkerRunnable<Params, Result> mWorker = new C02692();

    /* renamed from: android.support.v4.content.ModernAsyncTask$1 */
    static class C02681 implements ThreadFactory {
    ...
    class C02692 extends WorkerRunnable<Params, Result> {
        C02692() {
        }
