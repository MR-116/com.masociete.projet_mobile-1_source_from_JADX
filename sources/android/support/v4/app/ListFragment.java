...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C02632();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C02621();
    ...
    class C02632 implements OnItemClickListener {
        C02632() {
        }
