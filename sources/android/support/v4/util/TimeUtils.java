...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long duration, int fieldLen) {
        ...
        pos = printField(formatStr, hours, qb.f3193h, pos, pos != start, zeropad ? 2 : 0);
        pos = printField(formatStr, minutes, qb.f3198m, pos, pos != start, zeropad ? 2 : 0);
        pos = printField(formatStr, seconds, qb.f3194i, pos, pos != start, zeropad ? 2 : 0);
        int i = (!zeropad || pos == start) ? 0 : 3;
        pos = printField(formatStr, millis, qb.f3198m, pos, true, i);
        formatStr[pos] = qb.f3194i;
        return pos + 1;
    }
