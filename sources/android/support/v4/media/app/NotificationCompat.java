...
import android.support.mediacompat.C0232R;
...
public class NotificationCompat {
    ...
    public static class MediaStyle extends Style {
        ...
        RemoteViews generateContentView() {
            ...
            view.removeAllViews(C0232R.id.media_actions);
            if (numActionsInCompact > 0) {
                for (int i = 0; i < numActionsInCompact; i++) {
                    ...
                    view.addView(C0232R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(this.mActionsToShowInCompact[i])));
                }
            }
            if (this.mShowCancelButton) {
                view.setViewVisibility(C0232R.id.end_padder, 8);
                view.setViewVisibility(C0232R.id.cancel_action, 0);
                view.setOnClickPendingIntent(C0232R.id.cancel_action, this.mCancelButtonIntent);
                view.setInt(C0232R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0232R.integer.cancel_button_image_alpha));
            } else {
                view.setViewVisibility(C0232R.id.end_padder, 0);
                view.setViewVisibility(C0232R.id.cancel_action, 8);
            }
            return view;
        }
        ...
        private RemoteViews generateMediaActionButton(Action action) {
            ...
            RemoteViews button = new RemoteViews(this.mBuilder.mContext.getPackageName(), C0232R.layout.notification_media_action);
            button.setImageViewResource(C0232R.id.action0, action.getIcon());
            if (!tombstone) {
                button.setOnClickPendingIntent(C0232R.id.action0, action.getActionIntent());
            }
            if (VERSION.SDK_INT >= 15) {
                button.setContentDescription(C0232R.id.action0, action.getTitle());
            }
            return button;
        }

        int getContentViewLayoutResource() {
            return C0232R.layout.notification_template_media;
        }
        ...
        RemoteViews generateBigContentView() {
            ...
            big.removeAllViews(C0232R.id.media_actions);
            if (actionCount > 0) {
                for (int i = 0; i < actionCount; i++) {
                    big.addView(C0232R.id.media_actions, generateMediaActionButton((Action) this.mBuilder.mActions.get(i)));
                }
            }
            if (this.mShowCancelButton) {
                big.setViewVisibility(C0232R.id.cancel_action, 0);
                big.setInt(C0232R.id.cancel_action, "setAlpha", this.mBuilder.mContext.getResources().getInteger(C0232R.integer.cancel_button_image_alpha));
                big.setOnClickPendingIntent(C0232R.id.cancel_action, this.mCancelButtonIntent);
            } else {
                big.setViewVisibility(C0232R.id.cancel_action, 8);
            }
            return big;
        }

        int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0232R.layout.notification_template_big_media_narrow : C0232R.layout.notification_template_big_media;
        }
    }
    ...
    public static class DecoratedMediaCustomViewStyle extends MediaStyle {
        ...
        int getContentViewLayoutResource() {
            if (this.mBuilder.getContentView() != null) {
                return C0232R.layout.notification_template_media_custom;
            }
        ...
        int getBigContentViewLayoutResource(int actionCount) {
            return actionCount <= 3 ? C0232R.layout.notification_template_big_media_narrow_custom : C0232R.layout.notification_template_big_media_custom;
        }
        ...
        private void setBackgroundColor(RemoteViews views) {
            ...
            if (this.mBuilder.getColor() != 0) {
                ...
                color = this.mBuilder.mContext.getResources().getColor(C0232R.color.notification_material_background_media_default_color);
            }
            views.setInt(C0232R.id.status_bar_latest_event_content, "setBackgroundColor", color);
        }
    }
