...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C03291();
    ...
    static class C03291 implements Creator<PlaybackStateCompat> {
        C03291() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C03301();
        ...
        static class C03301 implements Creator<CustomAction> {
            C03301() {
            }
