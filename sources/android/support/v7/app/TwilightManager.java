...
class TwilightManager {
    ...
    private void updateState(@NonNull Location location) {
        ...
        calculator.calculateTwilight(now - hb.f2079l, location.getLatitude(), location.getLongitude());
        ...
        calculator.calculateTwilight(hb.f2079l + now, location.getLatitude(), location.getLongitude());
