...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04271();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04282();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C04293();
    ...
    class C04282 extends ViewPropertyAnimatorListenerAdapter {
        C04282() {
        }
    ...
    class C04293 implements ViewPropertyAnimatorUpdateListener {
        C04293() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0430R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0430R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0430R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0430R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0430R.styleable.ActionBar, C0430R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0430R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0430R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0430R.attr.actionBarWidgetTheme, outValue, true);
