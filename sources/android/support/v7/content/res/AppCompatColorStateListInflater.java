    ...
    private static ColorStateList inflate(@NonNull Resources r, @NonNull XmlPullParser parser, @NonNull AttributeSet attrs, @Nullable Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (depth < innerDepth && type == 3) {
                break;
            } else if (type == 2 && depth <= innerDepth && parser.getName().equals(C0679b.f1721u)) {
                TypedArray a = obtainAttributes(r, theme, attrs, C0430R.styleable.ColorStateListItem);
                int baseColor = a.getColor(C0430R.styleable.ColorStateListItem_android_color, -65281);
                float alphaMod = 1.0f;
                if (a.hasValue(C0430R.styleable.ColorStateListItem_android_alpha)) {
                    alphaMod = a.getFloat(C0430R.styleable.ColorStateListItem_android_alpha, 1.0f);
                } else if (a.hasValue(C0430R.styleable.ColorStateListItem_alpha)) {
                    alphaMod = a.getFloat(C0430R.styleable.ColorStateListItem_alpha, 1.0f);
                }
                a.recycle();
                ...
                while (i < numAttrs) {
                    ...
                    if (stateResId == 16843173 || stateResId == 16843551 || stateResId == C0430R.attr.alpha) {
                        j2 = j;
                    } else {
                        j2 = j + 1;
