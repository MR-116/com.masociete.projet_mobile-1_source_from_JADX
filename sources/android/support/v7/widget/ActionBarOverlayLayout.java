...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0430R.attr.actionBarSize, 16842841};
    ...
    class C04421 extends AnimatorListenerAdapter {
        C04421() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C04421();
        this.mRemoveActionBarHideOffset = new C04432();
        this.mAddActionBarHideOffset = new C04443();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0430R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0430R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0430R.id.action_bar));
        }
    }
