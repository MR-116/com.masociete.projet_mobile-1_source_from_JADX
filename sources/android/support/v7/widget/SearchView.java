...
import fr.pcsoft.wdjava.core.application.C0654o;
...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C04663 implements OnFocusChangeListener {
        C04663() {
        }
    ...
    class C04674 implements OnLayoutChangeListener {
        C04674() {
        }
    ...
    class C04696 implements OnKeyListener {
        C04696() {
        }
    ...
    class C04707 implements OnEditorActionListener {
        C04707() {
        }
    ...
    class C04718 implements OnItemClickListener {
        C04718() {
        }
    ...
    class C04729 implements OnItemSelectedListener {
        C04729() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = new C04731();
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C04731 implements ClassLoaderCreator<SavedState> {
            C04731() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0430R.attr.autoCompleteTextViewStyle);
        }

        public SearchAutoComplete(Context context, AttributeSet attrs, int defStyle) {
            super(context, attrs, defStyle);
            this.mRunShowSoftInputIfNecessary = new C04741();
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0430R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mUpdateDrawableStateRunnable = new C04641();
        this.mReleaseCursorRunnable = new C04652();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C04685();
        this.mTextKeyListener = new C04696();
        this.mOnEditorActionListener = new C04707();
        this.mOnItemClickListener = new C04718();
        this.mOnItemSelectedListener = new C04729();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0430R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0430R.styleable.SearchView_layout, C0430R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0430R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0430R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0430R.id.search_plate);
        this.mSubmitArea = findViewById(C0430R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0430R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0430R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0430R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0430R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0430R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0430R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0430R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0430R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0430R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0430R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0430R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0430R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0430R.styleable.SearchView_searchHintIcon);
        TooltipCompat.setTooltipText(this.mSearchButton, getResources().getString(C0430R.string.abc_searchview_description_search));
        this.mSuggestionRowLayout = a.getResourceId(C0430R.styleable.SearchView_suggestionRowLayout, C0430R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0430R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C04663());
        setIconifiedByDefault(a.getBoolean(C0430R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0430R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0430R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0430R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0430R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0430R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0430R.styleable.SearchView_android_focusable, true));
        a.recycle();
        ...
        if (this.mDropDownAnchor != null) {
            this.mDropDownAnchor.addOnLayoutChangeListener(new C04674());
        }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0430R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0430R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0430R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0430R.dimen.abc_dropdownitem_text_padding_left) : 0;
    ...
    private Intent createIntent(String action, Uri data, String extraData, String query, int actionKey, String actionMsg) {
        ...
        if (query != null) {
            intent.putExtra(C0654o.f1636b, query);
        }
        if (extraData != null) {
