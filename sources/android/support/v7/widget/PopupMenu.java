...
public class PopupMenu {
    ...
    class C04601 implements Callback {
        C04601() {
        }
    ...
    class C04612 implements android.widget.PopupWindow.OnDismissListener {
        C04612() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0430R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C04601());
        ...
        this.mPopup.setOnDismissListener(new C04612());
    }
